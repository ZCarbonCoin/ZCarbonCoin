...
config file):
	...
	HiddenServicePort 8037 127.0.0.1:8037
	HiddenServicePort 18037 127.0.0.1:18037

The directory can be different of course, but (both) port numbers should be equal to
your zcashd's P2P listen port (8037 by default).
...
and open port 8037 on your firewall (or use -upnp).
...
Now use zcash-cli to verify there is only a single peer connection.
	...
	[
	    {
	        "id" : 1,
	        "addr" : "zctestseie6wxgio.onion:18037",
	        ...
	        "version" : 170002,
